...
public class AlgoCharm {
	...
	private ITNode getCandidate(ITNode currNode, ITNode brother) {
		...
		// PERFORM TIDSETS INTERSECTION
		Set<Integer> commonTids = currNode.peformOptimizedTidSetsIntersection(brother, minsupRelative);
		// if the set of tid is null (because it could not reach minsup
		if(commonTids == null) {
			return null;
		}
