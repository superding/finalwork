...
public class MemoryEfficientItemsetTree implements Serializable {
...
loop1:	for(int i1value : itemset1){
	 ...
	 * Itemset1 is an ancestor of itemset2 if:
	 *    - itemset1 is null
	 *    - size(itemset1) < size(itemset2) &&  if itemset1 has k items, then the first k items of 
