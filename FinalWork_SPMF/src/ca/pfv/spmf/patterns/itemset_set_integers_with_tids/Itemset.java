...
public class Itemset extends AbstractItemset{
	...
	/** the list of transaction/sequence ids containing this itemset */
	 ...
	 /**
	  * Constructor if we want to set the itemset and tidset at the same time
	  */
	 ...
	 /**
	  * Constructor if we want to set the itemset
	  */
	...
	public Itemset union(Itemset itemset) {
		Set<Integer> unionItemset = new HashSet<Integer>(getItems());
